 ...
 * 
 */
package com.codemads.functional.programming5;
...
public class FP05CustomClass {
	...
	public static void main(String[] args) {
		...
		courses.stream().sorted(numofStudComparatorReviewFirst).sorted(numofStudComparatorInc).forEach(System.out::println);
		System.out.println("***********");		
